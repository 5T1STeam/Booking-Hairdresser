        ...
        <div class="modal fade" id="popup-book-shop">
                            ...
                            <div class="group-inforshop row container justify-content-between">
                                ...
                                <div class="group-service">
                                    ...
                                    <div class='col-2' style='text-align:right;'>
                                        <button type='button' class='btn btn-book'  data-toggle='modal' data-target='#book-" . $data['ID'] . "-" . $rows['ServiceId'] . "'>Book</button>
                                    </div>
                                    <hr>
                                </div>";
                                    }
            ...
            <div class="content">
                <div class="row">
                    ...
                    </svg>&nbsp&nbsp" . $data['GN']['PhoneNumber'] . " <button class=' float-right call'>Call</button></div>
                    ";
                        ?>
