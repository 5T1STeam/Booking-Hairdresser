...
<div class="row profile-page">
  ...
  <?php echo'
    ...
    <a class="sss" href="'.BASE_URL.'/profile/thongtintaikhoan/'.$data['GN']['Id'].'">
    ...
    <a class="sss" href="'.BASE_URL.'/profile/thongbaocuatoi/'.$data['GN']['Id'].'">
    ...
    <a class="sss" href="'.BASE_URL.'/profile/cuahangyeuthich/'.$data['GN']['Id'].'">
    ...
    <a class="sss" href="'.BASE_URL.'/profile/danhgiacuatoi/'.$data['GN']['Id'].'">
    <a class="sss" href="'.BASE_URL.'/profile/lichhen/'.$data['GN']['Id'].'">
    ...
    <a class="sss" href="'.BASE_URL.'/profile/lichsu/'.$data['GN']['Id'].'">
    ...
    <a class="sss" href="'.BASE_URL.'/profile/chinhsachbaomat/'.$data['GN']['Id'].'">
